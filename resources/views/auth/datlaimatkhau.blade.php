                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                ...
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Vui lòng nhập lại email để đặt lại mật khẩu</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('reset.perform') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Tiếp Tục</button>
                                        </div>
                                        <div class="text-center 2">
                                            <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Hủy</button>
                                        </div>
                                    </form>
                                </div>
                                <div id="alert">
