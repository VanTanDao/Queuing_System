<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            target="_blank">
            <img src="./img/Logo alta.png" class="navbar-brand-img h-100" alt="main_logo">
 ...
 {{-- <li class="nav-item">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'index') == true ? 'active' : '' }}" href="{{ route('thietbi', ['thietbi' => 'index']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'thietbi') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'thietbi']) }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'tables') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'tables']) }}">
                    ...
                    <span class="nav-link-text ms-1">Cấp só</span>
                </a>
            </li>
            <li class="nav-item">
